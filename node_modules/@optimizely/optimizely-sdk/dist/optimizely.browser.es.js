...
import { NOTIFICATION_TYPES as NOTIFICATION_TYPES$1, sprintf, generateUUID, keyBy as keyBy$1, objectValues, objectEntries, find } from '@optimizely/js-sdk-utils';
...
var OptimizelyUserContext = /** @class */ (function () {
    ...
    OptimizelyUserContext.prototype.findValidatedForcedDecision = function (flagKey, ruleKey) {
        ...
        if (forcedDecision) {
            ...
            if (variation) {
                if (ruleKey) {
                    logger.info(LOG_MESSAGES.USER_HAS_FORCED_DECISION_WITH_RULE_SPECIFIED, variationKey, flagKey, ruleKey, this.userId);
                    decideReasons.push([
                    ...
                    logger.info(LOG_MESSAGES.USER_HAS_FORCED_DECISION_WITH_NO_RULE_SPECIFIED, variationKey, flagKey, this.userId);
                    decideReasons.push([
                ...
                if (ruleKey) {
                    logger.info(LOG_MESSAGES.USER_HAS_FORCED_DECISION_WITH_RULE_SPECIFIED_BUT_INVALID, flagKey, ruleKey, this.userId);
                    decideReasons.push([
                    ...
                    logger.info(LOG_MESSAGES.USER_HAS_FORCED_DECISION_WITH_NO_RULE_SPECIFIED_BUT_INVALID, flagKey, this.userId);
                    decideReasons.push([
...
var createInstance = function (config) {
    try {
        ...
        var optimizelyOptions = __assign(__assign({ clientEngine: JAVASCRIPT_CLIENT_ENGINE }, config), { eventProcessor: eventProcessor.createEventProcessor(eventProcessorConfig), logger: logger$6,
